...
Route::get('/buscar', \App\Http\Controllers\Site\SearchController::class)->name('search');
Route::get('/sitemap.xml', \App\Http\Controllers\Site\SitemapController::class)->name('sitemap');
Route::get('/sitemap-index.xml', [\App\Http\Controllers\Site\SitemapController::class, 'index'])->name('sitemap.index');
...
Route::get('/privacidade', [\App\Http\Controllers\Site\LgpdController::class, 'privacy'])->name('privacidade');
Route::get('/lgpd', [\App\Http\Controllers\Site\LgpdController::class, 'rights'])->name('lgpd.rights');
Route::post('/lgpd', [\App\Http\Controllers\Site\LgpdController::class, 'storeRequest'])->name('lgpd.store');
Route::post('/lgpd/consent', [\App\Http\Controllers\Site\LgpdController::class, 'storeConsent'])->name('lgpd.consent');
