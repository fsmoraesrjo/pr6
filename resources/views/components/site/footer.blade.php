...
<footer class="footer" role="contentinfo">
    <div class="container footer__top">
        <div class="footer__brand">
            <img src="{{ asset('assets/logo-pr6-branca.webp') }}" alt="PR-6 · Pró-Reitoria de Planejamento e Gestão" class="footer__logo" width="180" height="56" loading="lazy" decoding="async">
